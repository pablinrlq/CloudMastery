...
const links = [
  { href: "/dashboard", label: "Visão geral", shortLabel: "Início", icon: "◫" },
  { href: "/course/ccp", label: "Cloud Practitioner", shortLabel: "CCP", icon: "◇" },
  { href: "/course/saa", label: "Solutions Architect", shortLabel: "SAA", icon: "△" },
];
